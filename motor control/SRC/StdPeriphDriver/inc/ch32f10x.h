...
#define __CH32F10x_STDPERIPH_VERSION_SUB    (0x00) /* [7:0] sub version */
...
/******  CH32 specific Interrupt Numbers *********************************************************/
  ...
  USBHD_IRQn                  = 43      /* USB Host and Device global Interrupt                 */
...
/******************  Bit definition for DBGMCU_CFGR register  *******************/
#define  DBGMCU_DBG_SLEEP                    ((uint32_t)0x00000001)        /* Debug Sleep Mode */
#define  DBGMCU_DBG_STOP                     ((uint32_t)0x00000002)        /* Debug Stop Mode */
#define  DBGMCU_DBG_STANDBY                  ((uint32_t)0x00000004)        /* Debug Standby mode */
#define  DBGMCU_TRACE_IOEN                   ((uint32_t)0x00000020)        /* Trace Pin Assignment Control */

#define  DBGMCU_TRACE_MODE                   ((uint32_t)0x000000C0)        /* TRACE_MODE[1:0] bits (Trace Pin Assignment Control) */
#define  DBGMCU_TRACE_MODE_0                 ((uint32_t)0x00000040)        /* Bit 0 */
#define  DBGMCU_TRACE_MODE_1                 ((uint32_t)0x00000080)        /* Bit 1 */

#define  DBGMCU_DBG_IWDG_STOP                ((uint32_t)0x00000100)        /* Debug Independent Watchdog stopped when Core is halted */
#define  DBGMCU_DBG_WWDG_STOP                ((uint32_t)0x00000200)        /* Debug Window Watchdog stopped when Core is halted */
#define  DBGMCU_DBG_TIM1_STOP                ((uint32_t)0x00000400)        /* TIM1 counter stopped when core is halted */
#define  DBGMCU_DBG_TIM2_STOP                ((uint32_t)0x00000800)        /* TIM2 counter stopped when core is halted */
#define  DBGMCU_DBG_TIM3_STOP                ((uint32_t)0x00001000)        /* TIM3 counter stopped when core is halted */
#define  DBGMCU_DBG_TIM4_STOP                ((uint32_t)0x00002000)        /* TIM4 counter stopped when core is halted */
#define  DBGMCU_DBG_CAN1_STOP                ((uint32_t)0x00004000)        /* Debug CAN1 stopped when Core is halted */
#define  DBGMCU_DBG_I2C1_SMBUS_TIMEOUT       ((uint32_t)0x00008000)        /* SMBUS timeout mode stopped when Core is halted */
#define  DBGMCU_DBG_I2C2_SMBUS_TIMEOUT       ((uint32_t)0x00010000)        /* SMBUS timeout mode stopped when Core is halted */
#define  DBGMCU_DBG_TIM8_STOP                ((uint32_t)0x00020000)        /* TIM8 counter stopped when core is halted */
#define  DBGMCU_DBG_TIM5_STOP                ((uint32_t)0x00040000)        /* TIM5 counter stopped when core is halted */
#define  DBGMCU_DBG_TIM6_STOP                ((uint32_t)0x00080000)        /* TIM6 counter stopped when core is halted */
#define  DBGMCU_DBG_TIM7_STOP                ((uint32_t)0x00100000)        /* TIM7 counter stopped when core is halted */
#define  DBGMCU_DBG_CAN2_STOP                ((uint32_t)0x00200000)        /* Debug CAN2 stopped when Core is halted */
#define  DBGMCU_DBG_TIM15_STOP               ((uint32_t)0x00400000)        /* Debug TIM15 stopped when Core is halted */
#define  DBGMCU_DBG_TIM16_STOP               ((uint32_t)0x00800000)        /* Debug TIM16 stopped when Core is halted */
#define  DBGMCU_DBG_TIM17_STOP               ((uint32_t)0x01000000)        /* Debug TIM17 stopped when Core is halted */
#define  DBGMCU_DBG_TIM12_STOP               ((uint32_t)0x02000000)        /* Debug TIM12 stopped when Core is halted */
#define  DBGMCU_DBG_TIM13_STOP               ((uint32_t)0x04000000)        /* Debug TIM13 stopped when Core is halted */
#define  DBGMCU_DBG_TIM14_STOP               ((uint32_t)0x08000000)        /* Debug TIM14 stopped when Core is halted */
#define  DBGMCU_DBG_TIM9_STOP                ((uint32_t)0x10000000)        /* Debug TIM9 stopped when Core is halted */
#define  DBGMCU_DBG_TIM10_STOP               ((uint32_t)0x20000000)        /* Debug TIM10 stopped when Core is halted */
#define  DBGMCU_DBG_TIM11_STOP               ((uint32_t)0x40000000)        /* Debug TIM11 stopped when Core is halted */
